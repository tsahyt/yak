...
-- server side! In some places, responses have been hard-coded as defined in the
-- IRC in order to extract necessary information. If you disagree with these
-- choices, pull requests are welcome.
--
